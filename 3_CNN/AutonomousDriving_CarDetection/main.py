...
# Implementation of object detection using the very powerful YOLO model. 
# Many of the ideas in this file are described in the two YOLO papers: [Redmon et al., 2016](https://arxiv.org/abs/1506.02640) and [Redmon and Farhadi, 2016](https://arxiv.org/abs/1612.08242). 
